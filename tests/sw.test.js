...
(async function () {
  ...
  ["./classify.js", "./rewards.js", "./records.js", "./gym.js", "./watch.js", "./manuscript.js", "./index.html", "./icons/shortcut-gym-96.png"].forEach(function (f) {
  ...
  check(/genkouyoushi-v7/.test(ctx.CACHE), "キャッシュ名の番号を上げた(" + ctx.CACHE + ")");
