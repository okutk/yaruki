...
(async function () {
  ...
  ["./classify.js", "./guess.js", "./rewards.js", "./records.js", "./gym.js", "./watch.js", "./manuscript.js", "./index.html", "./icons/shortcut-gym-96.png"].forEach(function (f) {
  ...
  check(/genkouyoushi-v8/.test(ctx.CACHE), "キャッシュ名の番号を上げた(" + ctx.CACHE + ")");
