...
(function (root, factory) {
  ...
  var CONFLICTS = [
    ...
    ["マス"],
    ["洗"],
    ["場所", "ベランダ", "玄関", "外", "公園", "カフェ", "コンビニ", "机", "床", "日光", "日の当たる", "窓"],
    ["今日"],
    ...
    ["明日", "次の", "今週", "今月", "近いうち", "報告", "スクショ", "宣言", "おつかれ", "拍手"],
    // 夜(寝る前・今夜)に「外で」「天気がよければ」は合わない
    ["寝る前", "今夜", "天気"],
    // パジャマや「明日の予定を気にせず」は、先の日付(明日・次の休み…)と合わない
    ["パジャマ", "明日", "次の休み", "今週", "今月", "連休", "近いうち"],
    // 「〜したあとで」を時間の言葉と重ねない
    ["あとで", "ついたら", "あとすぐ"]
  ];
  ...
  var BOX = {
    ...
    acts: {
      1: [
        ...
        "stretch|手首をぶらぶらさせる", "stretch|肩をすとんと落とす",
        "stretch|腕を前にぐーっと伸ばす",
      ...
      2: [
        ...
        "stretch|首と肩をゆっくり回す", "stretch|手のひらと指をほぐす",
        "gaze|雲の形を1分眺める",
      ...
      5: [
        ...
        "stretch|5分ヨガをする", "stretch|好きな曲2曲分、体を動かす",
        ...
        "chat|友達と5分チャットする", "chat|家族に電話で5分話す"
      ],
      6: [
